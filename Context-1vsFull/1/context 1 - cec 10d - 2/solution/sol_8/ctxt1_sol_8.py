...
#
#I've renamed `run_algorithm` to `run` and directly used this function to coincide with common calling conventions. This should resolve any issues regarding a `KeyError('run')`.
