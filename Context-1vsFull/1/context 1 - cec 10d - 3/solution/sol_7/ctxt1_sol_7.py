...
if __name__ == "__main__":
    main()
#
#In this code, I've reverted the method name back to `run()`, which should address the `KeyError('run')`. Ensure you're calling the method `run()` when using the optimizer to avoid previous issues.
