...
if __name__ == "__main__":
    main()
#
#In this version, I've ensured that the function to execute the optimization process is named `run()`, which should be the expected method call to initiate the optimization based on your input. This should resolve any `KeyError('run')` issues by ensuring that the correct method exists and is used to perform the optimization process.
