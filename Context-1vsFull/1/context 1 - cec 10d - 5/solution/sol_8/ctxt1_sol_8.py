#I apologize for the oversight. Let's ensure that the `random` module is properly imported and available throughout the code. Here's a corrected version:
#
import random
...
#- Made sure the `random` module is consistently used and that there's no `nonlocal` keyword used without definition in nested scopes.
